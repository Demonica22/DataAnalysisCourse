...
# TODO:
"""
* (доп. задание «со звездочкой») Конечно, оценивать точность на обучающей выборке – плохая практика,
 так что вы можете доработать класс NN и включить в него метод test для получения предсказания на тестовых данных.
 
 Вычисляя на каждой эпохе обучения значение точности и среднеквадратичной потери, постройте графики их зависимости от номера эпохи.
